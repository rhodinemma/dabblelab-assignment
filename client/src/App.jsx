  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center">
        <div className="p-10 md:w-2/3 lg:w-2/3 mx-auto">
          <div role="status">
            <svg
  ...
  return (
    <>
      <CountryContext.Provider value={{ selectedId, setSelectedId }}>
        ...
        <center>
          <h1 className="mb-4 mt-3 text-4xl font-abold tracking-tight leading-none text-gray-900 sm:px-40 md:text-5xl lg:text-6xl dark:text-white">
            Existing Records
          </h1>
        </center>
